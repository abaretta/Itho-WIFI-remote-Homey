...
// WIFI - enter your LAN Wifi details here
String ssid    = "<SSID>";
...
String host   = "<Homey LAN IP>";
const int httpPort    = 80;
String Bearer     ="<Homey bearer token>";
...
void handle_homey(String data, String variable) {
 ...
 // with an HTTP JSONPATH better logic card to write the value of the parameter to a Better Logic variable.
 // For controlling the fan HTTP GET action cards can be used, e.g. http://<nodeMcu-hostIP>/api?action=Medium
 // An additional action has been added to poll the sate: http://<nodeMcu-hostIP>/api?action=State
  client.print("POST /api/app/com.internet/itho HTTP/1.1\r\n");
  client.print("Host: " + host + "\r\n");
  client.print("Authorization: Bearer "+ Bearer +"");
  client.print("\r\n");
